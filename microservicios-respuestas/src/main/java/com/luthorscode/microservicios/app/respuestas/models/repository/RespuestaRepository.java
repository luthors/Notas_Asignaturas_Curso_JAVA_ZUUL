package com.luthorscode.microservicios.app.respuestas.models.repository;
...
public interface RespuestaRepository extends CrudRepository<Respuesta, Long> {
	@Query("select r from Respuesta r join fetch r.alumno a join fetch r.pregunta p join fetch p.examen"
			+ " e where a.id=?1 and e.id=?2")
